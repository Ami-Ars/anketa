  ...
  const cases = [
    {
      ...
      report: 'Проверил 47 новых вакансий за сутки. Подошла 1 — остальные отсеял: 21 гибрид, 14 без вилки, 11 не тот стек.',
      title: 'Senior Frontend',
      match: '94% совпадение',
      meta: '260 000 – 310 000 ₽ · полностью удалённо · React, TS',
      tag1: 'вилка указана',
      tag2: 'без тестового',
      why: 'Прислал, потому что вилка выше вашей и удалёнка без оговорок в тексте.'
    },
    {
